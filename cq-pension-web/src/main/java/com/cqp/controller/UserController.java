...
import com.cqp.model.User;
import com.cqp.service.api.UserService;
...
public class UserController {
    ...
    public Result login(@Valid @RequestBody User user, BindingResult bindingResult){
        ...
        if(userService.findList(user)==null){
            return new Result(true,StatusCode.LOGINERROR,"用户名或密码错误，登陆失败！",bindingResult.getFieldError().getDefaultMessage());
        }
